...
import org.wolf.security3.config.sms.SmsCodeAuthenticationSecurityConfig;
import org.wolf.security3.config.sms.SmsCodeFilter;
...
//                    .tokenValiditySeconds(7000)
        ...
        .and().csrf().disable()
        .apply(smsCodeAuthenticationSecurityConfig); //所有请求需要认证
    }
